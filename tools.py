...
_EVOLVED_OFFENSIVE_TOOLS = {
    "ad_exploit": ad_exploit_tool,
    "shellcraft": shellcraft_tool,
    "cloud_exploit": cloud_exploit_tool,
    "post_exploit": post_exploit_tool,
    "container_escape": container_escape_tool,
    "pivot_network": pivot_network_tool,
    "wireless_exploit": wireless_exploit_tool,
    "social_engineer": social_engineer_tool,
    "ics_scada_exploit": ics_scada_exploit_tool,
    "supply_chain_attack": supply_chain_attack_tool,
}
TOOL_MAP.update(_EVOLVED_OFFENSIVE_TOOLS)
...
_EXPLOIT_DEV_TOOLS = {
    "fuzz_target": fuzz_target_tool,
    "run_fuzzing_campaign": run_fuzzing_campaign_tool,
    "assess_exploitability": assess_exploitability_tool,
    "generate_shellcode": generate_shellcode_tool,
    "build_rop_chain": build_rop_chain_tool,
    "suggest_attack_chains": suggest_attack_chains_tool,
    "build_exploit_plan": build_exploit_plan_tool,
    "analyze_binary_security": analyze_binary_security_tool,
    "fuzz_http_endpoint": fuzz_http_endpoint_tool,
    "generate_heap_spray": generate_heap_spray_tool,
    "discover_zero_day": discover_zero_day_tool,
    "hunt_instagram": hunt_instagram_tool,
    "hunt_facebook": hunt_facebook_tool,
    "exploit_vulnerability": exploit_vulnerability_tool,
}
TOOL_MAP.update(_EXPLOIT_DEV_TOOLS)
...
try:
    from omega_auth_bypass import AUTH_BYPASS_TOOLS
    TOOL_MAP.update(AUTH_BYPASS_TOOLS)
