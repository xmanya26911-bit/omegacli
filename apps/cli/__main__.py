...
_ENTRY_DIR = os.path.dirname(os.path.abspath(__file__))  # apps/cli/
_REPO_ROOT = os.path.dirname(_ENTRY_DIR)                 # repo root

# Add both paths so 'omega' resolves to apps/cli/omega/ and 'packages' resolves to repo root
sys.path.insert(0, _REPO_ROOT)
sys.path.insert(0, _ENTRY_DIR)

# Add structured folder paths (relative to repo root)
